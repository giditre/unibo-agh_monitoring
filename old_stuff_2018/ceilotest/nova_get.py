...
base_address = 'http://controller:8774/v2.1/'
...
def nova_get(endpoint, base_address=base_address, token_file=token_file):
...
if __name__ == "__main__":
  ...
  print(nova_get(endpoint, base_address, token_file))
