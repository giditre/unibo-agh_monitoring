...
gnuplot -persist <<-EOF
  ...
  plot "data_choosePath_baseline.txt" using (\$1):(\$2*0.000001) title "Total" with linespoint dt 1 lw 3 pt 0 lc rgb "black", \
       "" using (\$1):(\$3*0.000001) with linespoints title "Network Path 1" dt 2 lw 3 pt 0 lc rgb "red"
